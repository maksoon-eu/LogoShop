                        ...
                        <div className="catalog__list-group">
                            <div className="catalog__list-mod" onClick={() => {onModifyList(false)}}>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M2 2V4.74H4.74V2H2ZM0 1.19C0 0.532785 0.532778 0 1.19 0H5.55C6.20723 0 6.74 0.532788 6.74 1.19V5.55C6.74 6.20721 6.20723 6.74 5.55 6.74H1.19C0.532778 6.74 0 6.20722 0 5.55V1.19ZM2 13.74V11H4.74V13.74H2ZM1.19 9C0.532778 9 0 9.53279 0 10.19V14.55C0 15.2072 0.532778 15.74 1.19 15.74H5.55C6.20723 15.74 6.74 15.2072 6.74 14.55V10.19C6.74 9.53279 6.20723 9 5.55 9H1.19ZM11 13.74V11H13.74V13.74H11ZM10.19 9C9.53278 9 9 9.53279 9 10.19V14.55C9 15.2072 9.53278 15.74 10.19 15.74H14.55C15.2072 15.74 15.74 15.2072 15.74 14.55V10.19C15.74 9.53279 15.2072 9 14.55 9H10.19ZM11 4.74V2H13.74V4.74H11ZM10.19 0C9.53278 0 9 0.532785 9 1.19V5.55C9 6.20722 9.53278 6.74 10.19 6.74H14.55C15.2072 6.74 15.74 6.20721 15.74 5.55V1.19C15.74 0.532788 15.2072 0 14.55 0H10.19Z" fill={!modifyList ? '#3B82F6' : 'black'}/>
                                </svg>
                            </div>
