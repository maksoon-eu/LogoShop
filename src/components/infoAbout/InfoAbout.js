...
const InfoAbout = () => {
    return (
        <>
            <div className="infoAbout__title">Доставка</div>
            <div className="infoAbout__text">Интернет-магазин выполняет доставку любого товара своей собственной Службой доставки.</div>
            <div className="infoAbout__title">Стоимость доставки курьером</div>
            <div className="infoAbout__text">Стоимость доставки товара из нашего магазина - 500 руб, при условии выбора при заказе товара в качестве способа доставки нашим курьером.</div>
            <div className="infoAbout__title">Время доставки</div>
            <div className="infoAbout__text">
                ...
                <p><span>Внимание!</span>Неправильно указанный номер телефона, неточный или неполный адрес могут привести к дополнительной задержке! Пожалуйста, внимательно проверяйте ваши персональные данные при регистрации и оформлении заказа.Конфиденциальность ваших регистрационных данных гарантируется.</p>
            ...
            <div className="infoAbout__title">Место доставки</div>
            <div className="infoAbout__text">Доставка осуществляется по адресу, указанному при оформлении заказа. Если необходимо доставить товар по иному адресу, необходимо сообщить адрес менеджеру Службы доставки, который свяжется с вами непосредственно после оформления заказа на сайте.</div>
            <div className="infoAbout__title">Правила</div>
            <div className="infoAbout__text">
